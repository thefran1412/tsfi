		...
		<div id="resource" class="container">
			...
			<div v-if="resource" class="col-xs-12 col-sm-4 col-md-4 col-lg-4 resource-extras">
				...
				<div v-if="resource[0].age[0]" class="resource-extras-tag">
					<h3> <i class="fa fa-users" aria-hidden="true"></i> Edats recomenades <!-- <i class="fa fa-graduation-cap" aria-hidden="true"> --></i></h3>
				...
				<!-- Logo entitat ** sin arreglar -->
					...
					<a class="socialMedia" v-if="resource[0].entity[0].facebook" :href="'https://www.facebook.com/'+ resource[0].entity[0].facebook" target="_blank" :title="'https://twitter.com/'+ resource[0].entity[0].twitter">
